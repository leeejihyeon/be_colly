...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handleDomainException(
        ...
        HttpStatus status = switch (ex.getErrorCode()) {
            case USER_NOT_FOUND, ORDER_NOT_FOUND, POST_NOT_FOUND, JOIN_NOT_FOUND, MAGIC_LINK_NOT_FOUND ->
                    HttpStatus.NOT_FOUND;
            case DUPLICATE_EMAIL, JOIN_ALREADY_EXISTS -> HttpStatus.CONFLICT;
            case INVALID_AMOUNT, JOIN_NOT_ALLOWED, INVALID_POST_PAYLOAD, AUTH_INVALID_EMAIL, AUTH_INVALID_PROVIDER,
                 AUTH_INVALID_PROVIDER_USER_ID, MAGIC_LINK_EXPIRED, MAGIC_LINK_ALREADY_USED -> HttpStatus.BAD_REQUEST;
            case REFRESH_TOKEN_NOT_FOUND, REFRESH_TOKEN_EXPIRED -> HttpStatus.UNAUTHORIZED;
