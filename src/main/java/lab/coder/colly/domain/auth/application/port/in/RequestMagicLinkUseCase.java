...
public interface RequestMagicLinkUseCase {
     ...
     * @return 매직링크 발급 결과
     */
    MagicLinkRequestResult request(MagicLinkRequestCommand command);
     ...
     */
    record MagicLinkRequestCommand(String email) {
    }
     ...
     */
    record MagicLinkRequestResult(String email, long expiresInSeconds, String magicToken) {
    }
}
