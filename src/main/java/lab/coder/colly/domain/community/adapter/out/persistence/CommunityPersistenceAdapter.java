...
public class CommunityPersistenceAdapter implements CommunityPostPort, CommunityJoinPort, CommunityReportPort, UserRestrictionPort {
        ...
        CommunityPostEntity saved =
                communityPostJpaRepository.save(
                        new CommunityPostEntity(
                                ...
                                post.getCityCode(),
                                post.getType(),
                                post.getAudienceScope(),
                                post.getAccommodationId(),
                                post.getAudienceStayStartDate(),
                                post.getAudienceStayEndDate(),
                                post.getContent(),
                                post.getImageUrl(),
    ...
    private CommunityPost toDomain(CommunityPostEntity entity) {
        return CommunityPost.restore(
                ...
                entity.getCityCode(),
                entity.getType(),
                entity.getAudienceScope(),
                entity.getAccommodationId(),
                entity.getAudienceStayStartDate(),
                entity.getAudienceStayEndDate(),
                entity.getContent(),
                entity.getImageUrl(),
